...
- (void) layoutWithModel:(id) model {
    ...
    NSString *vflString = @"H:|-15-[_avatorImageView]-0-[_nickLabel]-(>=0)-[_commentImageView(==_avatorImageView)]-0-[_commentLabel]-15-[_likeImageView(==_avatorImageView)]-0-[_likeLabel]-15-[_shareImageView(==_shareImageView)]-0-[_shareLabel]-15-|";
    NSArray<NSLayoutConstraint *> *layout = [NSLayoutConstraint constraintsWithVisualFormat:vflString
